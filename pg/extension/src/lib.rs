...
mod tests {
    ...
    #[pg_test]
    fn pg_fusion_runtime_filter_temporal_smoke() {
        super::smoke_tests::runtime_filter_temporal_smoke();
    }

    #[pg_test]
    fn pg_fusion_runtime_filter_numeric_smoke() {
        super::smoke_tests::runtime_filter_numeric_smoke();
    }
